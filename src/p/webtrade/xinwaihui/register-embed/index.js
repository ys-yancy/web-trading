...
*/
    ...
    doc.on('click', "#cboxAgreed", (e)=> {
        console.log("cboxAgreed clicked: " + $('#cboxAgreed')[0].checked );
    });
    doc.on('click', "#btnTrade", (e)=> {
        console.log("btnTrade clicked: ");
  ...
  _submit(e) {
    ...
    var d = {
      ...
      source: getRegisterSource() + ',embed',// getRegisterSource()从r.js里来
