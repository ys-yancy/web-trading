...
function getMobileRegisterLink() {
    return "http://t.invhero.com/s/guides.html?refer=/i/y5bk32?from=webtrade";
}

function getLogoUrl() {
    //return "../../img/xinwaihui/logo.jpg";
    return "../../img/logo.png";
}

function getDefaultAvatarUrl() {
    return "https://w.invhero.com/img/logo.png";
}

function getLogoBackgroudStyle() {
    return "img-wrapper-outer";
}
...
function getRegisterDefaultNickname() {
    ...
    var nickname = '访客t' + minite + '' + second + '' + millsecond;
    return nickname;
}
...
function getTradePageUrl() {
    return 'https://w.invhero.com/s/webtrade/trade.html';
}
...
function getExtraHtml() {
    return '\
        ...
        <p>6.交易结算只限使用银联卡。</p>\
        <p>7.每次最低交易金额为' + getMinDepositWL() + '美元，每次最高交易金额为30,000美元。</p>\
    ';
}

function getStatementContent() {
    return '<h2>投资英豪 & ETG</h2>\
            <p>投资英豪是由顶尖交易服务团队北京掌迭英豪科技有限公司为初入市场的投资者量身打造的交易学习产品。全球首创的声控交易，喊“涨” “跌”便可下单，极优化了交易体验，并在交易中融入学习模式，让初级投资者轻松掌握技巧，成为投资达人。 掌迭英豪致力于为投资者搭建更简单、更安全、更便捷的学习环境，引导投资者步步为赢的完成交易！</p>\
            <div class="believe">\
                <p>我们相信，学习投资可以很简单！</p>\
                <p>我们知道，交易决策可以更轻松！</p>\
                <p>我们提供，全球高手供参考！</p>\
            ...
            <div>\
                <p>投资英豪是ETG Broker 的会员单位，ETG Broker 是一家为零售及机构客户提供外汇交易及相关服务的主要环球供应商。受新西兰FSP(NewzealandFinancialServiceProviders)监管。目前，ETG Broker已向来自全球的80多个国家的近10万名交易者提供过服务。作为外汇行业领导者，我们在管理、安全性及财务报表方面均依照最高标准执行。</p>\
            </div>\
            <div>\
                <p>客户资金隔离存放: </p>\
...
function getRiskMsg () {
    return '<p class="marginTop">尊敬的投资英豪客户:</p>\
    <p class="marginTop txtIndent">投资英豪交易平台(以下统一使用"我平台"代替)的业务是一种潜在收益和潜在风险较高的投资业务,对投资者的风险承受能力、理解风险程度、风险控制能力以及投资经验有较高的要求。存入资金前，您需要仔细阅读以下高风险揭示协议。</p>\
...
function getTrueMsg() {
    ...
    <div>\
        <div>尊敬的投资英豪客户:</div>\
        <div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;尊敬的投资英豪(以下简称"我司")客户我们会间接为您提供电子商务平台支付服务,您拥有平台账户资金的使用所有权，您需要在我司交易平台注册账户并上传相关个人资料，您应接受我司对您资金结算的管理监督和检查。</div>\
...
function getAbountTitleContent() {
    return '<h2 class="desc-title">我们提供适合不同水平投资者的投资教育系统一站解决方案</h2>\
            <div class="desc-content">\
                <p>投资英豪汇聚来自各大互联网, 金融公司的行业精英, 专注于通过产品, 科技改变金融行业.</p>\
