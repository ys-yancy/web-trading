...
function getMobileRegisterLink() {
    return "http://t.yizim.com/yzgj/s/my-guide/yzgj/register.html?inviteCode=&from=webtrade";
}

// 白标的LOGO地址, 最好是http
function getLogoUrl() {
    // return "../../img/xinwaihui/logo.png";
    return "http://wt-yzgj.yizim.com/v2/yzgj/img/wl/yzgj/pay.png";
}
...
function getTradePageUrl() {
    return 'http://wt-yzgj.yizim.com/v2/yzgj/s/webtrade/trade.html';
}

// PC版注册页面的地址 (需要iframe)
function getRegisterPageUrl() {
    return 'http://wt-yzgj.yizim.com/v2/yzgj/s/webtrade/register.html';
}

// PC版入金页面 (需要iframe)
function getDepositButtonHref() {
    return "http://wt-yzgj.yizim.com/v2/yzgj/s/pay/guide.html";
}

// PC 版查看支持银行bank-list (需要iframe)
function getBankListHref() {
    return "http://wt-yzgj.yizim.com/v2/yzgj/s/pay/bank-list.html";
}
...
function getGroupPriceUrl() {
    return 'http://price.yizim.com/v1/price/current';
}

//ajax.js: priceUrl
function getPriceUrl() {
    return 'http://price.yizim.com/v2/price/current';
}

//ajax.js: candleUrl
function getCandleUrl() {
    return 'http://price.yizim.com/v3/price/candle';
}

//ajax请求前缀：正式环境
function getAjaxPrefix() {
    return 'http://api.yizim.com';
}

//邀请链接
function getInvitePrefix() {
    return 'http://t.yizim.com/i/';
}

//安卓分享前缀
function getAndroidSharePrefix() {
    return 'http://t.yizim.com';
}

//头像链接
function getAvatarUrl() {
    return 'http://static.yizim.com/';
}

//stompUrl
function getStompUrl() {
    return 'ws://price.yizim.com:61613/stomp';
}
...
function getUDFCompatibleDatafeedUrl() {
    return 'http://price.yizim.com/tradingview';
}
function getQuoteHelperUrl() {
    return 'ws://price.yizim.com:61613/stomp';
}
function getChartStorageUrl() {
    return 'http://api.yizim.com/v1/advchart';
}

//zhufeng\cooperation\index.js 109
function getFeedbackUrl() {
    return 'http://api.yizim.com/v1/feedback/';
}
